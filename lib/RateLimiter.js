class RateLimiter {
  constructor(limit = 1000, windowMs = 60 * 60 * 1000) {
...
// Export singleton configured for maximum 1000 downloads per hour
if (!global.__rateLimiterInstance) {
  global.__rateLimiterInstance = new RateLimiter(1000, 60 * 60 * 1000);
}
