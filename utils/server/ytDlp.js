  ...
  if (envCookieString) {
    ...
    if (envCookieString !== lastProcessedBase64 || !existsSync(tmpTxtPath)) {
      try {
        ...
        // Split by base64 delimiters (comma, semicolon) to handle concatenated values (do not split by = as it is padding)
        ...
        if (processedCount === 0) {
          throw new Error("No valid cookie content could be decoded.");
        }
        ...
        lastProcessedBase64 = envCookieString;
